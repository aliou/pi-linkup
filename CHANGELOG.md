...
- 7216696: Remove prepare script to avoid dev deps being installed on git installs
...
- 42481a6: refactor: per-extension entries to fix duplicate command registration
